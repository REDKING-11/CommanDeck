    ...
    private static boolean shouldTriggerKeybind(Minecraft client, ActionButtonData actionData) {
        ...
        if (keybind.size() >= 4) {
            if (keybind.get(3) == 0) {
                ...
                if (key != null && InputConstants.isKeyDown(client.getWindow().getWindow(), key.getValue())) {
                    ...
                    boolean isCtrlDown = InputConstants.isKeyDown(client.getWindow().getWindow(), GLFW.GLFW_KEY_LEFT_CONTROL) || InputConstants.isKeyDown(client.getWindow().getWindow(), GLFW.GLFW_KEY_RIGHT_CONTROL);
                    boolean isShiftDown = InputConstants.isKeyDown(client.getWindow().getWindow(), GLFW.GLFW_KEY_LEFT_SHIFT) || InputConstants.isKeyDown(client.getWindow().getWindow(), GLFW.GLFW_KEY_RIGHT_SHIFT);
                    boolean isAltDown = InputConstants.isKeyDown(client.getWindow().getWindow(), GLFW.GLFW_KEY_LEFT_ALT) || InputConstants.isKeyDown(client.getWindow().getWindow(), GLFW.GLFW_KEY_RIGHT_ALT);
